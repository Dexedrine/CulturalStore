...
class AdminCommuntyControllerTest extends WebTestCase {
	private static  $em;
	...
	public function testCreate() {
		...
		$crawler = $client->request ( 'GET', '/community/admin/create_theme' );
	...
	public function testAddCommunity() {
		...
		$crawler = $client->request ( 'GET', '/community/admin/add_community/' . $theme->getId () );
