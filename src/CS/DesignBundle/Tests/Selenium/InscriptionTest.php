...
class InscriptionTest extends PHPUnit_Extensions_SeleniumTestCase
{
  ...
  public function testInscription()
  {
    ...
    $this->type("id=cs_utilisateur_registration_form_email", "lucie@gmail.fr");
    $this->type("id=cs_utilisateur_registration_form_plainPassword_first", "lucie");
    $this->type("id=cs_utilisateur_registration_form_plainPassword_second", "lucie");
